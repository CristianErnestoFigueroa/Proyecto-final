...
insert into Productos values ('Guantes quirurgicos',2.50, 1)
insert into Productos values ('Jarabe para la tos',3.50, 3)
insert into Productos values ('Enjuague Bucal',3.50, 1)
